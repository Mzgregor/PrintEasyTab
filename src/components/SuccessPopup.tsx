                ...
                >
                    ...
                    <div className="bg-accent/10 border border-accent/30 rounded-2xl p-6 mb-6">
                        ...
                        <p className="text-text-secondary text-sm text-center mb-4">
                            En mode local, aucun email n'est envoyé. Utilisez le lien ci-dessous pour activer votre compte :
                        </p>
                    ...
                    <p className="text-text-secondary text-xs text-center italic">
                        💡 Le lien d'activation est également disponible dans la console du navigateur
                    </p>
                </div>
            </div>
        </>
